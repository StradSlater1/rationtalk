...
article = pd.read_csv('Scraped_news/101224/22.csv', encoding='utf-8',  converters={'Paragraphs': literal_eval})
...
dbscan_model = DBSCAN(eps=0.4, min_samples=2, metric='cosine')  # Adjust 'eps' as needed
...
print(summarize(combined_summary))
