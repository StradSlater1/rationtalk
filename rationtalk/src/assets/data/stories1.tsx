...
export const storiestouse: StoryData[] = [
  {
    topic: 'U.S.',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNVhNM2s1WVZaU1RYbHdaRFY2VFJDZkF4ampCU2dLTWdZQndJNUtQUVU=-w280-h168-p-df',
  ...
  {
    topic: 'U.S.',
    imageUrl: 'https://news.google.com/api/attachments/CC8iL0NnNVplRXN0VVZBemVFSkVjMnh0VFJDUUF4allCQ2dLTWdtaEFvcjBsQ3FMNVFJ=-w280-h168-p-df',
  ...
  {
    topic: 'Business',
    imageUrl: 'https://news.google.com/api/attachments/CC8iL0NnNVZOV3RsYm1SS01FTjBlVlZ5VFJDSEF4aVBCaWdLTWdrQkFJeXVzZVhJQVFN=-w280-h168-p-df',
    title: "Circle's Ambitious Stablecoin Network",
    summary: 'Circle is developing a comprehensive stablecoin network aimed at becoming the largest and most widely utilized in the world. Through its regulated affiliates, the company issues two primary stablecoins: USDC, which is pegged to the US dollar, and EURC, pegged to the euro. This initiative positions Circle at the forefront of the stablecoin market, emphasizing its commitment to regulatory compliance and financial stability.',
    questions: [
  ...
  {
    topic: 'Technology',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNXlOVTFDUXpWaE5sWjBlSFpmVFJEZ0F4aUFCU2dLTWdZQkE1U011UVk=-w280-h168-p-df',
    title: 'The Popularity of the Nintendo Switch 2 and Its Accessories',
    summary: 'The Nintendo Switch 2 console has quickly sold out at GameStop Canada, indicating a strong demand among consumers. Among the accessories, the Nintendo Switch 2 Pro Controller is expected to be particularly sought after, featuring significant enhancements over the previous model. Notable upgrades include the addition of a headphone jack, a new "C" button, and customizable back buttons, making it an appealing choice for gamers looking to enhance their experience.',
    questions: [
  ...
  {
    topic: 'Technology',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNU9SR3hPZVZOVVRVWkNPVWxKVFJERUF4aW1CU2dLTWdZcFpZck9MUVk=-w280-h168-p-df',
    title: 'Anticipating iOS 26 at WWDC 2025',
    summary: "At WWDC 2025, it is highly anticipated that Apple will unveil the 19th version of its mobile operating system, iOS 26. Francisco Jeronimo, VP of devices at IDC, expressed excitement about the potential new features and advancements related to Apple Intelligence that may be introduced. This follows the previous year's announcement of iOS 18 and the initial introduction of Apple Intelligence, along with updates to Siri that have yet to be implemented.",
    questions: [
  ...
  {
    topic: 'Technology',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNU5iVE4wVW1aTlFXaHlMWEpzVFJDZkF4ampCU2dLTWdZdGRJeVByUVU=-w280-h168-p-df',
    title: 'Samsung Galaxy Watch 7: A Top Choice for Smartwatch Buyers',
    summary: 'The Samsung Galaxy Watch 7 stands out as an excellent option for those in the market for a new smartwatch. With its advanced features, sleek design, and user-friendly interface, it caters to a wide range of needs and preferences, making it a compelling choice for both tech enthusiasts and casual users alike.',
    questions: [
  ...
  {
    topic: 'Entertainment',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNU1PV3BWZWkxUFkwRnlUV0pQVFJDcUJCaXFCQ2dLTWdhTk1JelZGQVk=-w280-h168-p-df',
  ...
  {
    topic: 'Sports',
    imageUrl: 'https://news.google.com/api/attachments/CC8iI0NnNUpWWEJ4WWpST1UyaGxlRTF0VFJERUF4aW1CU2dLTWdB=-w280-h168-p-df',
  ...
  {
    topic: 'Sports',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNWZaVWN0U25ZNFpHbDRRVEo1VFJDb0FSaXNBaWdCTWdhQkVJNnRFUXM=-w280-h168-p-df',
    title: 'Alcaraz Advances to Final Amidst Injury Withdrawals',
    summary: "Carlos Alcaraz reached the final of the tournament after his opponent, Lorenzo Musetti, retired due to injury. In the ongoing match, Jannik Sinner faced Novak Djokovic, with Sinner attempting to regain momentum after Djokovic showcased impressive shots to take a lead. Notably, Sinner has not lost a set at Roland Garros this year. Alcaraz praised Musetti's skills, acknowledging the challenge he presented in their match, particularly in the first two sets, which were fiercely contested.",
    questions: [
  ...
  {
    topic: 'Sports',
    imageUrl: 'https://news.google.com/api/attachments/CC8iI0NnNU1SV1ptV1VWWGFuRnJXV1IzVFJEcUFSaWdBeWdLTWdB=-w280-h168-p-df',
    title: 'Coaching Changes in the NHL: The Case of Pete DeBoer and the Dallas Stars',
  ...
  {
    topic: 'Sports',
    imageUrl: 'https://news.google.com/api/attachments/CC8iMkNnNTFRMDlFTFY5SFpFcFVXSFZqVFJDZkF4amlCU2dLTWd1QkVwYm9uU2s5NC1wYWd3=-w280-h168-p-df',
    title: 'Reflections on UFC 316 and Fighter Mindsets',
    summary: 'In the lead-up to UFC 316, fighter Sean O’Malley expressed a sense of satisfaction with his performance, despite the competitive nature of the sport. The event features a co-main bout between Julianna Pena and Kayla Harrison for the women’s Bantamweight title, highlighting the significance of rematches in mixed martial arts. O’Malley, like many fighters, views the opportunity to face opponents who have previously bested them as a chance for redemption, regardless of whether the fight is for a championship title. The early preliminaries for UFC 316 are set to air on ESPN, showcasing the excitement surrounding the event.',
    questions: [
  ...
  {
    topic: 'Sports',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNDVSV1JKUTBjelZqUkZkM2N4VFJDZkF4ampCU2dLTWdZQk1JZ3JxUVU=-w280-h168-p-df',
  ...
  {
    topic: 'Science',
    imageUrl: 'https://news.google.com/api/attachments/CC8iL0NnNVFXVXBUTW5nMVdrOVdPVXBZVFJDZkF4ampCU2dLTWdrQm80cE9PYVc0RXdF=-w280-h168-p-df',
  ...
  {
    topic: 'Science',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNHdZWGxTYUZKdmVXOUJSRGRIVFJDZkF4amtCU2dLTWdZMWtvZ1N0UVU=-w280-h168-p-df',
    title: "NASA's Budget Cuts and Leadership Changes for 2026",
    summary: 'The fiscal year 2026 budget allocates $18.8 billion to NASA, marking a significant reduction of $6 billion, or approximately 25%, from the previous year. This budget includes over $7 billion dedicated to lunar exploration and introduces $1 billion in new investments aimed at Mars-focused programs. Additionally, President Trump recently announced the withdrawal of his nomination of billionaire Jared Isaacman to lead NASA, indicating a shift in leadership as the agency navigates these budgetary changes.',
    questions: [
  ...
  {
    topic: 'Health',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNWtORTFRTWtkTFpVcHhZemxaVFJDUUF4allCQ2dLTWdZaFZJeXNLUVk=-w280-h168-p-df',
  ...
  {
    topic: 'Health',
    imageUrl: 'https://news.google.com/api/attachments/CC8iL0NnNDVOekJPUjNSWlN6ZG9ja1IwVFJDZkF4ampCU2dLTWdraEVKYnJHU29lcFFJ=-w280-h168-p-df',
  ...
  {
    topic: 'Health',
    imageUrl: 'https://news.google.com/api/attachments/CC8iL0NnNWZObUZ0UVZRemNuWTFXR0V5VFJDb0FSaXNBaWdCTWdrSk00WnRJZWVaTVFF=-w280-h168-p-df',
  ...
  {
    topic: 'Health',
    imageUrl: 'https://news.google.com/api/attachments/CC8iK0NnNUNhREE1T0dFdFVHY3pVVmRHVFJDcUJCaXFCQ2dLTWdZcE5JNlFNUVk=-w280-h168-p-df',
